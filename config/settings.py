...
# EC2 + CloudFront 環境
# ALLOWED_HOSTS に EC2 のドメイン・CloudFront ドメインを列挙する
# 例: api.your-domain.com,xxxx.cloudfront.net
...
CORS_ALLOWED_ORIGINS = os.getenv(
    ...
    'http://localhost:8081,http://192.168.1.13:8081'
).split(',')
# 本番では CORS_ALLOW_ALL_ORIGINS=True にするか、
